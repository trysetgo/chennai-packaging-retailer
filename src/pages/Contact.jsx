...
<Footer gap="32px" style={JSON.parse(`{}`)} logoAlt="कंपनी का लोगो" logoSrc="http://localhost:5174/images/tsg-logo.webp" logoText="" paddingX="24px" paddingY="48px" linkColor="#D1D5DB" textAlign="left" textColor="#9CA3AF" borderColor="#374151" socialLinks={JSON.parse(`[{"id":"sm1","url":"#","platform":"फेसबुक"},{"id":"sm2","url":"#","platform":"चहचहाना"},{"id":"sm3","url":"#","platform":"Instagram"}]`)} footerLayout="default" linkFontSize="14px" linkSections={JSON.parse(`[{"id":"s1","links":[{"id":"l1","url":"#","text":"के बारे में"},{"id":"l2","url":"#","text":"करियर"},{"id":"l3","url":"#","text":"प्रेस"}],"title":"कंपनी"},{"id":"s2","links":[{"id":"l4","url":"#","text":"ब्लॉग"},{"id":"l5","url":"#","text":"सहायता केंद्र"},{"id":"l6","url":"#","text":"संपर्क"}],"title":"संसाधन"}]`)} logoMaxWidth="150px" logoTextSize="18px" textFontSize="14px" columnsMobile={1} columnsTablet={2} copyrightText="© 2026 योरब्रांड। सर्वाधिकार सुरक्षित।" logoTextColor="#F9FAFB" showTopBorder={true} titleFontSize="14px" columnsDesktop={4} linkHoverColor="#F9FAFB" socialIconSize="28px" backgroundColor="#111827" contentMaxWidth="1200px" showSocialLinks={true} socialIconShape="circle" brandDescription="निर्मित लेआउट के माध्यम से दुनिया को एक बेहतर जगह बनाना।" showBottomBorder={true} showLinkSections={true} sectionTitleColor="#F3F4F6" brandDescriptionColor="#9CA3AF"></Footer>
    </div>
  );
}
