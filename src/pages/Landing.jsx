...
<HowItWorksProcessSection gap="32px" steps={JSON.parse(`[]`)} style={JSON.parse(`{}`)} title="How It Works" columns={3} eyebrow="4 simple steps" subtitle="A simple process designed for speed and reliability." alignment="left" className="" marginTop="0px" cardBorder="1px solid #e2e8f0" cardShadow="0 14px 32px rgba(15,23,42,0.12)" marginLeft="0px" numberSize="31px" paddingTop="40px" titleColor="#0f172a" accentColor="#ebbf1e" cardPadding="18px" marginRight="0px" paddingLeft="16px" showNumbers={true} marginBottom="0px" minCardWidth="216px" paddingRight="16px" glassmorphism={true} paddingBottom="40px" showConnector={true} subtitleColor="#475569" cardHoverScale={1.1} connectorColor="#cbd5e1" stepTitleColor="#0f172a" headingFontSize="30px" numberTextColor="#ffffff" cardBorderRadius="14px" subtitleFontSize="15px" containerMaxWidth="1280px" headingFontWeight="700" stepTitleFontSize="16px" cardBackgroundColor="#ffffff" stepTitleFontWeight="600" stepDescriptionColor="#64748b" hideConnectorOnMobile={true} numberBackgroundColor="#0f172a" sectionBackgroundColor="#f3f2dd" stepDescriptionFontSize="13px"></HowItWorksProcessSection>
