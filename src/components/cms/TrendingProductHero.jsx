...
export const defaultProps = {
  ...
  description:
    "Get premium packaging solutions with fast turnaround, competitive pricing, and eco-friendly materials.",
  categories: [
    "Product Boxes",
    "Mailer Boxes",
    "Rigid Boxes",
  ...
  products: [
    {
      ...
      description:
        "Perfect for retail and display. Fully customizable with premium finishes.",
      image:
        "https://images.unsplash.com/photo-1626244463486-136b8e390cc2?auto=format&fit=crop&q=80&w=600",
    ...
    },
    {
      ...
      description:
        "Durable and stylish corrugated boxes for e-commerce shipments.",
      image:
    ...
    },
    {
      ...
      description:
        "Premium unboxing experience for high-end products and gifts.",
      image:
    ...
    },
    {
      ...
      description:
        "Keep your products safe during transit with our sturdy shipping boxes.",
      image:
    ...
    },
    {
      ...
      description:
        "FDA-approved custom boxes for bakeries, takeaways, and restaurants.",
      image:
        "https://images.unsplash.com/photo-1608198093002-ad4e005484ec?auto=format&fit=crop&q=80&w=600",
    ...
    },
    {
      ...
      description:
        "Keep pizzas hot and fresh. Custom printed with your brand logo.",
      image:
...
const TrendingProductHero = (props) => {
  ...
  const filteredProducts = (products || []).filter(
    (p) => p.category === activeCategoryName,
  );
  ...
  useEffect(() => {
    ...
    if (
      ...
      !categoryNames.includes(activeCategoryName)
    ) {
  ...
  const safeIndex =
    currentIndex >= displayProducts.length ? 0 : Math.max(0, currentIndex);
  ...
  return (
    <div
      ...
      style={{
        ...
        padding:
          styles.padding !== undefined ? `${styles.padding}px` : "64px 0",
                ...
                {features.map((feature, idx) => (
                  <div key={idx}>
                    {feature.link ? (
                      <a
                        href={feature.link}
                        className="flex items-center space-x-2 text-sm font-medium transition-opacity hover:opacity-80"
                      >
                        {feature.image ? (
                          <img
                            src={feature.image}
                    ...
                    <Tag
                      ...
                      style={{
                        backgroundColor: isActive
                          ? styles.pillActiveBackgroundColor
                          : styles.pillBackgroundColor,
                        color: isActive
                          ? styles.pillActiveTextColor
